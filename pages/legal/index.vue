            ...
            <div class="grow">
              <div class="h-full flex flex-col">
                ...
                <div class="pt-1 mt-auto">
                  <NuxtLink to="#" class="mt-2.5 text-sm text-black text-opacity-50">Перейти</NuxtLink>
                </div>
              </div>
            </div>
          </div>

          <NuxtLink class="after:absolute after:inset-0 after:z-10" to="/legal/privacy"></NuxtLink>
        </div>
        <!-- End Card -->
        <!-- Card -->
        <div class="p-4 group relative flex flex-col border border-gray-200 bg-white hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700/50 dark:hover:border-neutral-700 rounded-lg">
          <div class="h-full flex gap-x-5">
            ...
            <div class="grow">
              <div class="h-full flex flex-col">
                ...
                <div class="pt-1 mt-auto">
                  <NuxtLink to="/cookie" class="mt-2.5 text-sm text-black text-opacity-50">Перейти</NuxtLink>
                </div>
              </div>
            </div>
          </div>

          <NuxtLink class="after:absolute after:inset-0 after:z-10" to="/legal/cookie"></NuxtLink>
        </div>
        <!-- End Card -->
        <!-- Card -->
        <div class="p-4 group relative flex flex-col border border-gray-200 bg-white hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700/50 dark:hover:border-neutral-700 rounded-lg">
          <div class="h-full flex gap-x-5">
            ...
            <div class="grow">
              <div class="h-full flex flex-col">
                ...
                <div class="pt-1 mt-auto">
                  <NuxtLink to="/legal/agreement" class="mt-2.5 text-sm text-black text-opacity-50">Перейти</NuxtLink>
                </div>
              </div>
            </div>
          </div>

          <NuxtLink class="after:absolute after:inset-0 after:z-10" to="/legal/agreement"></NuxtLink>
        </div>
        <!-- End Card -->
        <!-- Card -->
        <div class="p-4 group relative flex flex-col border border-gray-200 bg-white hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700/50 dark:hover:border-neutral-700 rounded-lg">
          ...
          <NuxtLink class="after:absolute after:inset-0 after:z-10" to="/legal/offer"></NuxtLink>
        </div>
        <!-- End Card -->
        <!-- Card -->
        <div class="p-4 group relative flex flex-col border border-gray-200 bg-white hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700/50 dark:hover:border-neutral-700 rounded-lg">
          ...
          <NuxtLink class="after:absolute after:inset-0 after:z-10" to="/legal/beta"></NuxtLink>
        </div>
        <!-- End Card -->
        <!-- Card -->
        <div class="p-4 group relative flex flex-col border border-gray-200 bg-white hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700/50 dark:hover:border-neutral-700 rounded-lg">
          ...
          <NuxtLink class="after:absolute after:inset-0 after:z-10" to="/legal/promotion-terms"></NuxtLink>
        </div>
        <!-- End Card -->
      </div>
      <!-- End Grid -->
