...
<template>
  ...
  <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Платформы</h4>

        <div class="mt-3 grid space-y-3 text-sm">
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Доска объявлений</a></p>
        </div>
      </div>
      <!-- End Col -->

      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Система</h4>

        <div class="mt-3 grid space-y-3 text-sm">
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">О системе</a></p>
          ...
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="features">Возможности</a></p>
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Полезная информация</h4>
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Сотрудничество</h4>
      ...
      <div class="sm:flex sm:justify-between sm:items-center">
        <div class="flex items-center gap-x-3">
          ...
          <div class="space-x-4 text-sm ms-4">
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Пользовательское соглашение</a>
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Обработка персональных данных</a>
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Статус системы</a>
          </div>
        </div>
