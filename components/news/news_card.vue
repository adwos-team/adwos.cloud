      ...
      <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
        ...
        <span class="block mb-1 text-xs font-semibold uppercase text-blue-600 dark:text-blue-500">
          ...
          <h3 class="text-xl font-semibold text-gray-800 dark:text-neutral-300 dark:hover:text-white">
            Чат для общения с вами<br>в Telegram
          </h3>
          <p class="mt-3 text-gray-500 dark:text-neutral-500">
            Мы создали чат для общения с вами в мессенджере Telegram.
            <br><br>
            Присоединяйтесь, читайте последние анонсы, задавайте вопросы разработчикам и общайтесь с пользователями платформы Adwos CMS.
          </p>
        </div>
        <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700">
          <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-es-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 rounded-xl" href="#">
            Читать
          </a>
        </div>
      </div>
