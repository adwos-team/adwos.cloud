  ...
  <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      <div class="col-span-full hidden lg:col-span-1 lg:block">
        <NuxtLink to="/" class="flex gap-1.5 whitespace-nowrap">
      ...
      <div>
        ...
        <div class="mt-3 grid space-y-3 text-sm">
          <p><NuxtLink class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" to="#">Доска объявлений</NuxtLink></p>
        </div>
      </div>
      <!-- End Col -->
      ...
      <div class="sm:flex sm:justify-between sm:items-center">
        ...
        <div class="flex justify-between items-center">
          <div class="mt-3 sm:hidden">
            <NuxtLink class="flex-none text-xl font-semibold dark:text-white" to="#" aria-label="Brand">Adwos</NuxtLink>
            <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© 2022 Adwos 2024.</p>
          </div>

          <!-- Social Brands -->
          <div class="space-x-4">
            <NuxtLink class="inline-block text-gray-500 hover:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200" to="#">
